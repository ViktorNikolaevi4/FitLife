...
private struct CreateWorkoutExerciseTemplateScreen: View {
    ...
    private let iconOptions: [ExerciseIconOption] = [
        ...
        .init(systemImage: WorkoutExerciseIcon.assaultBike),
        .init(systemImage: WorkoutExerciseIcon.skiErg),
        .init(systemImage: WorkoutExerciseIcon.stairMaster),
        ...
        .init(systemImage: WorkoutExerciseIcon.deadBug),
        .init(systemImage: WorkoutExerciseIcon.birdDog),
        .init(systemImage: WorkoutExerciseIcon.crunches),
        .init(systemImage: WorkoutExerciseIcon.abWheelRollout),
        .init(systemImage: WorkoutExerciseIcon.powerClean),
        .init(systemImage: WorkoutExerciseIcon.hangClean),
        .init(systemImage: WorkoutExerciseIcon.blockClean),
        .init(systemImage: WorkoutExerciseIcon.powerSnatch),
        .init(systemImage: WorkoutExerciseIcon.cleanPull),
        .init(systemImage: WorkoutExerciseIcon.hangSnatch),
        .init(systemImage: WorkoutExerciseIcon.blockSnatch),
        .init(systemImage: WorkoutExerciseIcon.overheadSquat),
        .init(systemImage: WorkoutExerciseIcon.splitJerk),
        .init(systemImage: WorkoutExerciseIcon.kettlebellSwing),
        .init(systemImage: WorkoutExerciseIcon.singleArmDumbbellSnatch),
        .init(systemImage: WorkoutExerciseIcon.dumbbellClean),
        .init(systemImage: WorkoutExerciseIcon.doubleUnders),
        .init(systemImage: WorkoutExerciseIcon.toesToBar),
        .init(systemImage: WorkoutExerciseIcon.handstandPushUp),
        .init(systemImage: WorkoutExerciseIcon.ropeClimb),
        .init(systemImage: WorkoutExerciseIcon.devilPress),
        .init(systemImage: WorkoutExerciseIcon.barMuscleUp),
        .init(systemImage: WorkoutExerciseIcon.ringMuscleUp),
        .init(systemImage: WorkoutExerciseIcon.handstandWalk),
        .init(systemImage: WorkoutExerciseIcon.sandbagCarry),
        .init(systemImage: WorkoutExerciseIcon.bearCrawl),
        .init(systemImage: WorkoutExerciseIcon.boxJumpOver),
