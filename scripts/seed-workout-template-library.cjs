...
const templates = [
  {
    ...
    parent: {
      title: "Разминка 1",
      titleKey: "trainer.templates.library.template.warmup_1.title",
    ...
    exercises: [
      {
        ...
        data: {
          blockId: "warmup",
          exerciseKey: "workout.exercise.bodyweight_squat",
          name: "Приседания со своим весом",
          systemImage: "Приседания со своим весом",
          accentName: "orange",
      ...
      },
      {
        ...
        data: {
          blockId: "warmup",
          exerciseKey: "workout.exercise.push_ups",
  ...
  },
  {
    ...
    parent: {
      title: "Разминка 2",
      titleKey: "trainer.templates.library.template.warmup_2.title",
      notes: "",
      category: "warmup",
      difficulty: "",
      durationMinutes: 2,
    ...
    blocks: [
      {
        ...
        data: {
          title: "Суперсет",
          typeRawValue: "superset",
          modeRawValue: "rounds",
          presetRawValue: "superset",
          orderIndex: 0,
          rounds: 1,
          durationMinutes: 2,
          workSeconds: 0,
    ...
    exercises: [
      {
        ...
        data: {
          ...
          note: "",
          sets: [
            { weight: 0, reps: 15, durationSeconds: 30, metricType: "reps" },
          ],
        },
      },
      {
        ...
        data: {
          blockId: "superset",
          exerciseKey: "workout.exercise.knee_push_ups",
          name: "Отжимания от колен",
          systemImage: "Отжимание от колен",
          accentName: "blue",
          activityTypeRaw: "strength",
          metValue: 3.5,
          orderIndex: 1,
      ...
      },
      {
        ...
        data: {
          blockId: "superset",
          exerciseKey: "workout.exercise.jumping_jack",
          name: "Jumping Jack",
          systemImage: "JumpingJack",
          accentName: "blue",
          activityTypeRaw: "hiit",
          metValue: 8.0,
          orderIndex: 2,
          note: "",
          sets: [
            { weight: 0, reps: 0, durationSeconds: 30, metricType: "duration" },
          ],
        },
      },
      {
        ...
        data: {
          blockId: "superset",
          exerciseKey: "workout.exercise.elbow_plank",
          name: "Планка на локтях",
          systemImage: "Планка на локтях",
          accentName: "blue",
          activityTypeRaw: "core",
          metValue: 3.5,
          orderIndex: 3,
          note: "",
          sets: [
            { weight: 0, reps: 0, durationSeconds: 20, metricType: "duration" },
          ],
        },
      },
    ],
